...
def extrair_carta_verde(texto: str) -> Optional[CartaVerdeExtraida]:
    ...
    # 1. Plate Portuguesa (formatos: 00-00-AA, 00-AA-00, AA-00-00, AA-00-AA)
    # Procurar primeiro após indicação de matrícula ou padrão isolado
    matricula = None
    ...
    # Padrão 1: "02 06 2026" ... "02 12 2026"
    ...
    # Padrão alternativo: DD/MM/AAAA ou DD-MM-AAAA
    ...
    if "divina" in t_lower:
        ...
        # Tentar extrair do campo "Este certificado foi emitido por:"
    ...
    # Ex: P / 5085 / 142001304364 ou P/5085/142001304364
    ...
    if match_apolice:
        ...
        # Fallback para número de apólice simples
    ...
    if match_marca:
        ...
        # Limpar prefixos de categoria (ex: "A RENAULT Mégane...")
        candidato = re.sub(r"^[A-G]\s+", "", candidato).strip()
        marca_modelo = candidato
    else:
        # Procura marcas conhecidas
